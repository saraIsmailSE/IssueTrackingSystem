		...
		<div class="main-wrapper-first">
			...
			<section class="about-generic-area">
				<div class="container border-top-generic">
					<h3 class="about-title mb-70">About Dinomuz</h3>
					<div class="row">
						<div class="col-md-12">
							<div class="img-text">
					...
					<div class="row align-items-center">
						<div class="col-lg-3">
							<div class="story-title">
								...
								<span class="text-uppercase text-white">Dinomuz Issue</span>
							</div>
						</div>
						<div class="col-lg-6">
							<div class="story-box">
								<h6 class="text-uppercase">For More Information</h6>
								<p>Contact Us</p>
								<a href="contact.php" class="primary-btn hover d-inline-flex align-items-center"><span class="mr-10">Lets Talk</span><span class="lnr lnr-arrow-right"></span></a>
							</div>
						</div>
					</div>
				</div>
